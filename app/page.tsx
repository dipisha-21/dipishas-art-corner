  ...
  return (
    <div className="space-y-20">
      ...
      <section className="pt-4">
        <div className="flex flex-col md:flex-row md:items-center gap-10">
          <div className="space-y-6 md:flex-1">
            ...
            <div className="flex flex-wrap gap-3 text-xs">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="px-4 py-2 rounded-full bg-white text-black hover:bg-accent hover:text-black transition"
              >
                View full Pinterest
              </a>
              <a
                href="#contact"
                className="px-4 py-2 rounded-full border border-white/20 hover:border-accent text-muted hover:text-white transition"
              >
          ...
          <div className="md:flex-1 flex justify-end">
            <div className="relative w-48 h-56 md:w-64 md:h-72 rounded-3xl bg-gradient-to-br from-accent/40 via-surface to-surface border border-accent/30 shadow-[0_0_80px_rgba(245,179,209,0.25)]" />
          </div>
        </div>
      </section>
      ...
      <section id="work" className="space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {featuredArt.map((item) => (
            <article
              key={item.title}
              className="group rounded-2xl border border-white/5 bg-surface/80 p-4 flex flex-col gap-3 hover:border-accent/60 transition"
            >
              <div className="aspect-[4/3] rounded-xl bg-gradient-to-br from-white/5 via-white/2 to-white/0 group-hover:from-accent/20 group-hover:via-accent/5 transition" />
              <div className="flex items-center justify-between">
                <h3 className="text-sm font-medium">{item.title}</h3>
                <span className="text-[10px] px-2 py-1 rounded-full border border-white/10 text-muted">
                  {item.tag}
                </span>
              </div>
            </article>
      ...
      <section id="pinterest" className="space-y-4">
        ...
        <div className="rounded-2xl border border-white/5 bg-surface/80 p-4">
      ...
      <section id="about" className="space-y-4">
        ...
        <div className="rounded-2xl border border-white/5 bg-surface/80 p-4 text-sm text-muted leading-relaxed">
          <p>
      ...
      <section id="contact" className="space-y-4 mb-10">
        ...
        <div className="rounded-2xl border border-white/5 bg-surface/80 p-4 flex flex-col gap-3 text-sm">
